...
declare module "cs_script/point_script" {
    ...
    class Domain {
        ...
        OnBeforePlayerDamage(
            callback: (event: { player: CSPlayerPawn; damage: number; inflictor?: Entity; attacker?: Entity; weapon?: CSWeaponBase }) => BeforeDamageResult
        ): void
        /**
        ...
        ConnectOutput(
            target: Entity,
            output: string,
            callback: (inputData: { value?: InputValue; caller?: Entity; activator?: Entity }) => any
        ): number | undefined
        ...
        EntFireAtTarget(
            target: Entity,
            input: string,
            inputData?: InputValue | { value?: InputValue; caller?: Entity; activator?: Entity },
            delay?: number
        ): void
    }
